   ...
   public static void main(String[] args){
    ...
    //  };
     CheckerData[] data2 = new CheckerData[]{
      ...
      new CheckerData(0, 1, 1, 0, 0f),
      new CheckerData(1, 1, 1, 0, 0f),
      new CheckerData(0, 0, 0, 1, 1f),
      new CheckerData(1, 0, 0, 1, 1f),
      new CheckerData(0, 1, 0, 1, 1f),
      new CheckerData(1, 1, 0, 1, 1f),
      new CheckerData(0, 0, 1, 1, 1f),
      new CheckerData(1, 0, 1, 1, 1f),
      new CheckerData(0, 1, 1, 1, 1f),
      new CheckerData(1, 1, 1, 1, 1f),
    };
