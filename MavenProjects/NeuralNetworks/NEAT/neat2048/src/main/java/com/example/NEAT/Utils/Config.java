...
public class Config {
    ...
    public static final double CompatibilityThreshold = 0.45;

    //Mutation
    public static final double perturbWeightChance = 0.1;
    public static final double scrambleWeightChance = 0.06;
    public static final double pointMutationChance = 0.05;
    public static final double addConnectionChance = 0.2;
    public static final double addNodeChance = 0.1;
