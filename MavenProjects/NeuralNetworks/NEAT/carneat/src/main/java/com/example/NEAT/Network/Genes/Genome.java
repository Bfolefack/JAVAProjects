...
public class Genome implements Serializable {
    ...
    public static int maxInputs = Config.inNodes;
    public static int maxOutputs = Config.outNodes;
    ...
    public Genome(Genome genome) {
        ...
        for (ConnectionGene connection : genome.connections.values()) {
            connections.put(connectionInnovations.get(connection.in.idNum).get(connection.out.idNum), connection.copy());
        }
        generateNetwork();
    }
